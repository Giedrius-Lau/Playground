...
export const Header2 = () => {
    return (
        <div className='flex flex-col items-center justify-center max-w-2xl px-4 pt-16 mx-auto sm:max-w-xl md:max-w-2xl lg:pt-32 md:px-8'>
                ...
                <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto'>
                    <span className='relative inline-block'>
                        ...
                        >
                            ...
                            <rect fill='url(#9ef1ff62-feb2-41fe-8163-772b4c79de7b)' width='52' height='24' />
                        </svg>
            ...
            <img src='https://kitwind.io/assets/kometa/half-phone.png' className='w-full mx-auto md:w-auto md:max-w-xs' alt='' />
        </div>
    );
};
