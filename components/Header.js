...
export default function Header() {
    ...
    return (
        <div className='px-4 py-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-3xl md:px-24 lg:px-8 shadow-md fixed top-0 w-full z-10 bg-white'>
            <div className='relative flex grid items-center grid-cols-2 lg:grid-cols-3'>
                ...
                <a href='/' aria-label='Company' title='Company' className='inline-flex items-center lg:mx-auto'>
                    <h1 className='font-bold text-3xl text-purple-300 bg-gray-800 px-3 py-2 rounded-sm shadow-2xl'>HARD RESET</h1>
                </a>
